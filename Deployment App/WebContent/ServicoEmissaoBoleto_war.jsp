...
<% String directory = "/u/deploy/ServicoEmissaoBoleto_war"; %>
<% String tmpdirectory = "/u/deploy/ServicoEmissaoBoleto_war/tmp"; %>
...
<html>
<head>
<title>ServicoEmissaoBoleto_war</title>
<style TYPE="text/css">
<!--
.style1 {
	font-size: 12px;
...
<body>
<h2 style="text-align: center;">DEPLOY AUTOMATIZADO - ServicoEmissaoBoleto_war</h2>
<ul class="style1">
<%
         ...
         } catch (Exception e)
	   {
         ...
         if ( (todo != null) && (todo.equalsIgnoreCase("upload")) )
         {
           ...
           if ( (files != null) && (!files.isEmpty()) )
           {
             ...
             upBean.setFolderstore(directory+account);
             String str ="/u/opt/IBM/WebSphere/AppServer/profiles/Dmgr01/monitoredDeployableApps/deploymentProperties/ServicoEmissaoBoleto_war.props";
...
<form method="post" action="ServicoEmissaoBoleto_war.jsp" name="upform" enctype="multipart/form-data">
