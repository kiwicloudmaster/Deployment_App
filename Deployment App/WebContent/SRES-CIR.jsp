...
<% String directory = "/u/deploy/SRES-CIR"; %>
<% String tmpdirectory = "/u/deploy/SRES-CIR/tmp"; %>
...
<body>
<h2 style="text-align: center;">DEPLOY AUTOMATIZADO - SRES-CIR</h2>
<ul class="style1">
<%
         ...
         } catch (Exception e)
	   {
         ...
         if ( (todo != null) && (todo.equalsIgnoreCase("upload")) )
         {
           ...
           if ( (files != null) && (!files.isEmpty()) )
           {
             ...
             upBean.setFolderstore(directory+account);
             String str ="/u/opt/IBM/WebSphere/AppServer/profiles/Dmgr01/monitoredDeployableApps/deploymentProperties/SRES-CIR.props";
...
<form method="post" action="SRES-CIR.jsp" name="upform" enctype="multipart/form-data">
