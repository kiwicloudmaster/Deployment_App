...
<% String directory = "/u/deploy/EmissaoBoleto_war"; %>
<% String tmpdirectory = "/u/deploy/EmissaoBoleto_war/tmp"; %>
...
<body>
<h2 style="text-align: center;">DEPLOY AUTOMATIZADO - EmissaoBoleto_war</h2>
<ul class="style1">
<%
         ...
         } catch (Exception e)
	   {
         ...
         if ( (todo != null) && (todo.equalsIgnoreCase("upload")) )
         {
           ...
           if ( (files != null) && (!files.isEmpty()) )
           {
             ...
             upBean.setFolderstore(directory+account);
             String str ="/u/opt/IBM/WebSphere/AppServer/profiles/Dmgr01/monitoredDeployableApps/deploymentProperties/EmissaoBoleto_war.props";
...
<form method="post" action="EmissaoBoleto_war.jsp" name="upform" enctype="multipart/form-data">
