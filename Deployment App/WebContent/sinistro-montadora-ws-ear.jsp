...
<% String directory = "/u/deploy/sinistro-montadora-ws-ear"; %>
<% String tmpdirectory = "/u/deploy/sinistro-montadora-ws-ear/tmp"; %>
...
<html>
<head>
<title>sinistro-montadora-ws-ear</title>
<style TYPE="text/css">
<!--
.style1 {
	font-size: 12px;
...
<body>
<h2 style="text-align: center;">DEPLOY AUTOMATIZADO - sinistro-montadora-ws-ear</h2>
<ul class="style1">
<%
         ...
         } catch (Exception e)
	   {
         ...
         if ( (todo != null) && (todo.equalsIgnoreCase("upload")) )
         {
           ...
           if ( (files != null) && (!files.isEmpty()) )
           {
             ...
             upBean.setFolderstore(directory+account);
             String str ="/u/opt/IBM/WebSphere/AppServer/profiles/Dmgr01/monitoredDeployableApps/deploymentProperties/sinistro-montadora-ws-ear.props";
...
<form method="post" action="sinistro-montadora-ws-ear.jsp" name="upform" enctype="multipart/form-data">
