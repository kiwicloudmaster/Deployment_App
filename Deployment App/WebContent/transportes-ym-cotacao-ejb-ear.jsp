...
<% String directory = "/u/deploy/transportes-ym-cotacao-ejb-ear"; %>
<% String tmpdirectory = "/u/deploy/transportes-ym-cotacao-ejb-ear/tmp"; %>
...
<html>
<head>
<title>transportes-ym-cotacao-ejb-ear</title>
<style TYPE="text/css">
<!--
.style1 {
	font-size: 12px;
...
<body>
<h2 style="text-align: center;">DEPLOY AUTOMATIZADO - transportes-ym-cotacao-ejb-ear</h2>
<ul class="style1">
<%
         ...
         } catch (Exception e)
	   {
         ...
         if ( (todo != null) && (todo.equalsIgnoreCase("upload")) )
         {
           ...
           if ( (files != null) && (!files.isEmpty()) )
           {
             ...
             upBean.setFolderstore(directory+account);
             String str ="/u/opt/IBM/WebSphere/AppServer/profiles/Dmgr01/monitoredDeployableApps/deploymentProperties/transportes-ym-cotacao-ejb-ear.props";
...
<form method="post" action="transportes-ym-cotacao-ejb-ear.jsp" name="upform" enctype="multipart/form-data">
