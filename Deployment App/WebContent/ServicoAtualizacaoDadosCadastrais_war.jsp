...
<% String directory = "/u/deploy/ServicoAtualizacaoDadosCadastrais_war"; %>
<% String tmpdirectory = "/u/deploy/ServicoAtualizacaoDadosCadastrais_war/tmp"; %>
...
<html>
<head>
<title>ServicoAtualizacaoDadosCadastrais_war</title>
<style TYPE="text/css">
<!--
.style1 {
	font-size: 12px;
...
<body>
<h2 style="text-align: center;">DEPLOY AUTOMATIZADO - ServicoAtualizacaoDadosCadastrais_war</h2>
<ul class="style1">
<%
         ...
         } catch (Exception e)
	   {
         ...
         if ( (todo != null) && (todo.equalsIgnoreCase("upload")) )
         {
           ...
           if ( (files != null) && (!files.isEmpty()) )
           {
             ...
             upBean.setFolderstore(directory+account);
             String str ="/u/opt/IBM/WebSphere/AppServer/profiles/Dmgr01/monitoredDeployableApps/deploymentProperties/ServicoAtualizacaoDadosCadastrais_war.props";
...
<form method="post" action="ServicoAtualizacaoDadosCadastrais_war.jsp" name="upform" enctype="multipart/form-data">
