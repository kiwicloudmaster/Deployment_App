...
<% String directory = "/u/deploy/ConsultaOficinasRefREST"; %>
<% String tmpdirectory = "/u/deploy/ConsultaOficinasRefREST/tmp"; %>
...
<html>
<head>
<title>ConsultaOficinasRefREST</title>
<style TYPE="text/css">
html, body {
	font-size: 12px;
	font-family: Verdana;
...
<body>
<h2 style="text-align: center;">DEPLOY AUTOMATIZADO - ConsultaOficinasRefREST</h2>
<ul class="style1">
<%
         ...
         } catch (Exception e)
	   {
         ...
         if ( (todo != null) && (todo.equalsIgnoreCase("upload")) )
         {
           ...
           if ( (files != null) && (!files.isEmpty()) )
           {
             ...
             upBean.setFolderstore(directory+account);
             String str ="/u/opt/IBM/WebSphere/AppServer/profiles/Dmgr01/monitoredDeployableApps/deploymentProperties/ConsultaOficinasRefREST.props";
...
<form method="post" action="ConsultaOficinasRefREST.jsp" name="upform" enctype="multipart/form-data">
