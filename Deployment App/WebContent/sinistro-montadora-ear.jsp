...
<% String directory = "/u/deploy/sinistro-montadora-ear"; %>
<% String tmpdirectory = "/u/deploy/sinistro-montadora-ear/tmp"; %>
...
<html>
<head>
<title>sinistro-montadora-ear</title>
<style TYPE="text/css">
html, body {
	font-size: 12px;
	font-family: Verdana;
...
<body>
<h2 style="text-align: center;">DEPLOY AUTOMATIZADO - sinistro-montadora-ear</h2>
<ul class="style1">
<%
         ...
         } catch (Exception e)
	   {
         ...
         if ( (todo != null) && (todo.equalsIgnoreCase("upload")) )
         {
           ...
           if ( (files != null) && (!files.isEmpty()) )
           {
             ...
             upBean.setFolderstore(directory+account);
             String str ="/u/opt/IBM/WebSphere/AppServer/profiles/Dmgr01/monitoredDeployableApps/deploymentProperties/sinistro-montadora-ear.props";
...
<form method="post" action="sinistro-montadora-ear.jsp" name="upform" enctype="multipart/form-data">
