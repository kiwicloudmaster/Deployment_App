...
<% String directory = "/u/deploy/transportes-faturamento-ejb-ear"; %>
<% String tmpdirectory = "/u/deploy/transportes-faturamento-ejb-ear/tmp"; %>
...
<html>
<head>
<title>transportes-faturamento-ejb-ear</title>
<style TYPE="text/css">
html, body {
	font-size: 12px;
	font-family: Verdana;
...
<body>
<h2 style="text-align: center;">DEPLOY AUTOMATIZADO - transportes-faturamento-ejb-ear</h2>
<ul class="style1">
<%
         ...
         } catch (Exception e)
	   {
         ...
         if ( (todo != null) && (todo.equalsIgnoreCase("upload")) )
         {
           ...
           if ( (files != null) && (!files.isEmpty()) )
           {
             ...
             upBean.setFolderstore(directory+account);
             String str ="/u/opt/IBM/WebSphere/AppServer/profiles/Dmgr01/monitoredDeployableApps/deploymentProperties/transportes-faturamento-ejb-ear.props";
...
<form method="post" action="transportes-faturamento-ejb-ear.jsp" name="upform" enctype="multipart/form-data">
