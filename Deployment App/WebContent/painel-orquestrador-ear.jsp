...
<% String directory = "/u/deploy/painel-orquestrador-ear"; %>
<% String tmpdirectory = "/u/deploy/painel-orquestrador-ear/tmp"; %>
...
<html>
<head>
<title>painel-orquestrador-ear</title>
<style TYPE="text/css">
<!--
.style1 {
	font-size: 12px;
...
<body>
<h2 style="text-align: center;">DEPLOY AUTOMATIZADO - painel-orquestrador-ear</h2>
<ul class="style1">
<%
         ...
         } catch (Exception e)
	   {
         ...
         if ( (todo != null) && (todo.equalsIgnoreCase("upload")) )
         {
           ...
           if ( (files != null) && (!files.isEmpty()) )
           {
             ...
             upBean.setFolderstore(directory+account);
             String str ="/u/opt/IBM/WebSphere/AppServer/profiles/Dmgr01/monitoredDeployableApps/deploymentProperties/painel-orquestrador-ear.props";
...
<form method="post" action="painel-orquestrador-ear.jsp" name="upform" enctype="multipart/form-data">
